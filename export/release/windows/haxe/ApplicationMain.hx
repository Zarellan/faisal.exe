...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("PsychEngine16", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("PsychEngine16", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "PsychEngine16";
		app.meta["name"] = "Friday Night Funkin': Psych Engine1";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: false,
			title: "Friday Night Funkin': Psych Engine1",
			width: 1280,
			x: null,
			y: null,
		};
