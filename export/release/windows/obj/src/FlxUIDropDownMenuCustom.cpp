...
HXDLIN( 461)		 ::flixel::math::FlxPoint mousePoint1 = mousePoint->getScreenPosition(this->get_camera(),null());
HXLINE( 462)		 ::flixel::math::FlxPoint objPoint = this->getScreenPosition(null(),this->get_camera());
