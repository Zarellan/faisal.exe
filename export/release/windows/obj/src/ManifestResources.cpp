...
HXLINE(  53)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__assets_fonts_cairo_variablefont_slnt_wght_ttf >());
...
HXLINE(  82)		{
HXLINE(  82)			::String v8 = (::ManifestResources_obj::rootPath + HX_("manifest/week7.json",53,1e,57,58));
HXDLIN(  82)			::lime::utils::Assets_obj::libraryPaths->set(HX_("week7",c3,95,be,c7),v8);
            		}
HXLINE(  83)		{
HXLINE(  83)			::String v9 = (::ManifestResources_obj::rootPath + HX_("manifest/default.json",95,ea,cc,42));
HXDLIN(  83)			::lime::utils::Assets_obj::libraryPaths->set(HX_("default",c1,d8,c3,9b),v9);
            		}
...
HXLINE(  88)			::ManifestResources_obj::preloadLibraryNames->push(HX_("videos",98,d7,95,e5));
            		}
...
HXLINE(  95)		library = ::lime::utils::Assets_obj::getLibrary(HX_("week2",be,95,be,c7));
HXLINE(  96)		if (::hx::IsNotNull( library )) {
HXLINE(  96)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  97)			::ManifestResources_obj::preloadLibraryNames->push(HX_("week2",be,95,be,c7));
            		}
HXLINE(  98)		library = ::lime::utils::Assets_obj::getLibrary(HX_("week3",bf,95,be,c7));
HXLINE(  99)		if (::hx::IsNotNull( library )) {
HXLINE(  99)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 100)			::ManifestResources_obj::preloadLibraryNames->push(HX_("week3",bf,95,be,c7));
            		}
HXLINE( 101)		library = ::lime::utils::Assets_obj::getLibrary(HX_("week4",c0,95,be,c7));
HXLINE( 102)		if (::hx::IsNotNull( library )) {
HXLINE( 102)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 103)			::ManifestResources_obj::preloadLibraryNames->push(HX_("week4",c0,95,be,c7));
            		}
HXLINE( 104)		library = ::lime::utils::Assets_obj::getLibrary(HX_("week5",c1,95,be,c7));
HXLINE( 105)		if (::hx::IsNotNull( library )) {
HXLINE( 105)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 106)			::ManifestResources_obj::preloadLibraryNames->push(HX_("week5",c1,95,be,c7));
            		}
HXLINE( 107)		library = ::lime::utils::Assets_obj::getLibrary(HX_("week6",c2,95,be,c7));
HXLINE( 108)		if (::hx::IsNotNull( library )) {
HXLINE( 108)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 109)			::ManifestResources_obj::preloadLibraryNames->push(HX_("week6",c2,95,be,c7));
            		}
HXLINE( 110)		library = ::lime::utils::Assets_obj::getLibrary(HX_("week7",c3,95,be,c7));
HXLINE( 111)		if (::hx::IsNotNull( library )) {
HXLINE( 111)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 112)			::ManifestResources_obj::preloadLibraryNames->push(HX_("week7",c3,95,be,c7));
            		}
HXLINE( 113)		library = ::lime::utils::Assets_obj::getLibrary(HX_("default",c1,d8,c3,9b));
HXLINE( 114)		if (::hx::IsNotNull( library )) {
HXLINE( 114)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 115)			::ManifestResources_obj::preloadLibraryNames->push(HX_("default",c1,d8,c3,9b));
            		}
            	}
