...
HXDLIN( 253)				_g = (_g + 1);
HXLINE( 255)				 ::flixel::math::FlxPoint fh = letter->offset;
HXDLIN( 255)				fh->set_x((fh->x + add));
            			}
            		}
            	}
...
HXDLIN( 284)				_g = (_g + 1);
HXLINE( 286)				 ::flixel::math::FlxPoint fh = letter->offset;
HXDLIN( 286)				fh->set_x((fh->x + add));
HXLINE( 287)				if ((roundedValue < 0)) {
HXLINE( 287)					 ::flixel::math::FlxPoint fh = letter->offset;
HXDLIN( 287)					fh->set_x((fh->x + 10));
            				}
            			}
            		}
            	}
