...
HXDLIN(  74)		 ::flixel::graphics::FlxGraphic returnAsset = ::Paths_obj::returnGraphic(HX_("menuBGMagenta",65,29,40,00),library);
...
HXLINE(  97)					optionText1->set_y((optionText1->y - ( (Float)(55) )));
HXLINE(  98)					 ::flixel::math::FlxPoint fh = optionText1->startPosition;
HXDLIN(  98)					fh->set_y((fh->y - ( (Float)(55) )));
            				}
