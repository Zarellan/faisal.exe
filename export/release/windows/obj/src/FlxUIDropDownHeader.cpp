...
HX_DEFINE_STACK_FRAME(_hx_pos_1ef3565f039122bb_573_new,"FlxUIDropDownHeader","new",0x97b20556,"FlxUIDropDownHeader.new","FlxUIDropDownMenuCustom.hx",573,0xf5f4ce17)
static const int _hx_array_data_fe8b6264_1[] = {
	(int)1,(int)1,(int)14,(int)14,
};
HX_LOCAL_STACK_FRAME(_hx_pos_1ef3565f039122bb_616_destroy,"FlxUIDropDownHeader","destroy",0x3da114f0,"FlxUIDropDownHeader.destroy","FlxUIDropDownMenuCustom.hx",616,0xf5f4ce17)
...
void FlxUIDropDownHeader_obj::__construct(::hx::Null< int >  __o_Width, ::flixel::FlxSprite Background, ::flixel::addons::ui::FlxUIText Text, ::flixel::addons::ui::FlxUISpriteButton Button){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_1ef3565f039122bb_573_new)
HXLINE( 574)		super::__construct(null(),null());
HXLINE( 576)		this->background = Background;
HXLINE( 577)		this->text = Text;
HXLINE( 578)		this->button = Button;
HXLINE( 581)		if (::hx::IsNull( this->background )) {
HXLINE( 583)			this->background =  ::flixel::addons::ui::FlxUI9SliceSprite_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) ),HX_("flixel/flixel-ui/img/box.png",dd,a4,cf,5b), ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,0,0,Width,20),::Array_obj< int >::fromData( _hx_array_data_fe8b6264_1,4),null(),null(),null(),null(),null(),null(),null(),null());
            		}
HXLINE( 587)		if (::hx::IsNull( this->button )) {
HXLINE( 589)			this->button =  ::flixel::addons::ui::FlxUISpriteButton_obj::__alloc( HX_CTX ,0,0, ::flixel::FlxSprite_obj::__alloc( HX_CTX ,0,0,HX_("flixel/flixel-ui/img/dropdown_mark.png",cd,eb,34,3e)),null());
HXLINE( 590)			 ::flixel::addons::ui::FlxUISpriteButton _hx_tmp = this->button;
HXDLIN( 590)			_hx_tmp->loadGraphicSlice9(::cpp::VirtualArray_obj::__new(1)->init(0,HX_("flixel/flixel-ui/img/button_thin.png",58,62,55,9f)),80,20,::Array_obj< ::Dynamic>::__new(1)->init(0,::flixel::util::FlxStringUtil_obj::toIntArray(HX_("6,6,11,11",c0,1f,fa,07))),0,-1,false,18,18,null());
            		}
HXLINE( 593)		 ::flixel::addons::ui::FlxUISpriteButton _hx_tmp = this->button;
HXDLIN( 593)		Float _hx_tmp1 = this->background->get_height();
HXDLIN( 593)		_hx_tmp->resize(_hx_tmp1,this->background->get_height());
HXLINE( 594)		 ::flixel::addons::ui::FlxUISpriteButton _hx_tmp2 = this->button;
HXDLIN( 594)		Float _hx_tmp3 = this->background->x;
HXDLIN( 594)		Float _hx_tmp4 = (_hx_tmp3 + this->background->get_width());
HXDLIN( 594)		_hx_tmp2->set_x((_hx_tmp4 - this->button->get_width()));
HXLINE( 597)		this->button->set_width(( (Float)(Width) ));
HXLINE( 598)		 ::flixel::math::FlxPoint fh = this->button->offset;
HXDLIN( 598)		fh->set_x((fh->x - ( (Float)((Width - this->button->frameWidth)) )));
HXLINE( 599)		this->button->set_x(this->offset->x);
HXLINE( 600)		 ::flixel::math::FlxPoint fh1 = ( ( ::flixel::FlxSprite)(this->button->label) )->offset;
HXDLIN( 600)		fh1->set_x((fh1->x + this->button->offset->x));
HXLINE( 603)		if (::hx::IsNull( this->text )) {
HXLINE( 605)			this->text =  ::flixel::addons::ui::FlxUIText_obj::__alloc( HX_CTX ,0,0,::Std_obj::_hx_int(this->background->get_width()),null(),null(),null());
            		}
HXLINE( 607)		this->text->setPosition(2,4);
HXLINE( 608)		this->text->set_color(-16777216);
HXLINE( 610)		this->add(this->background);
HXLINE( 611)		this->add(this->button);
HXLINE( 612)		this->add(this->text);
            	}
...
void FlxUIDropDownHeader_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_1ef3565f039122bb_616_destroy)
HXLINE( 617)		this->super::destroy();
HXLINE( 619)		this->background = ( ( ::flixel::FlxSprite)(::flixel::util::FlxDestroyUtil_obj::destroy(this->background)) );
HXLINE( 620)		this->text = ( ( ::flixel::addons::ui::FlxUIText)(::flixel::util::FlxDestroyUtil_obj::destroy(this->text)) );
HXLINE( 621)		this->button = ( ( ::flixel::addons::ui::FlxUISpriteButton)(::flixel::util::FlxDestroyUtil_obj::destroy(this->button)) );
            	}
