...
::__ASSET__OPENFL__assets_fonts_cairo_variablefont_slnt_wght_ttf_obj::__register();
::__ASSET__assets_fonts_vcr_ttf_obj::__register();
::__ASSET__assets_fonts_pixel_otf_obj::__register();
::__ASSET__assets_fonts_cairo_variablefont_slnt_wght_ttf_obj::__register();
