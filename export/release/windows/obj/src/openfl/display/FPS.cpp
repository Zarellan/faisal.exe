...
HXLINE(  93)			this->set_text(HX_("",00,00,00,00));
HXLINE(  95)			this->set_textColor(-1);
HXLINE(  96)			bool _hx_tmp;
HXDLIN(  96)			if (!((memoryMegas > 3000))) {
HXLINE(  96)				_hx_tmp = (this->currentFPS <= (( (Float)(::ClientPrefs_obj::framerate) ) / ( (Float)(2) )));
            			}
            			else {
HXLINE(  96)				_hx_tmp = true;
            			}
HXDLIN(  96)			if (_hx_tmp) {
HXLINE(  98)				this->set_textColor(-65536);
            			}
HXLINE( 107)			this->set_text((this->get_text() + HX_("\n",0a,00,00,00)));
            		}
HXLINE( 110)		this->cacheCount = currentCount;
            	}
